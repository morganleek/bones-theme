...
function theme_add_editor_styles( WP_Screen $screen ) {
	if ( $screen->base !== 'post' )
		return; // 'post_type' is not checked, assuming all CPTs could have gutenberg
...
// 		add_action('wp_head', [$this, 'bones_theme_dev']);
// 		add_action('wp_footer', [$this, 'bones_theme_load_favicons']);
...
// 	public function bones_theme_dev() {
// 		print "<script type=\"module\" src=\"http://localhost:5173/@vite/client\"></script>";
// 		print "<script type=\"module\" src=\"http://localhost:5173/index.js\"></script>";
// 	}
