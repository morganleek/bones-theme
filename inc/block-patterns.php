<?php
	function bones_theme_register_block_patterns() {
		// Pattern Sections
		...
		$block_patterns = apply_filters( 'bones_theme_block_patterns', $block_patterns );

		foreach ( $block_patterns as $block_pattern ) {
			$pattern_file = get_theme_file_path( '/inc/patterns/' . $block_pattern . '.php' );

			register_block_pattern(
				'bones-theme/' . $block_pattern,
				require $pattern_file
			);
		}
	}
	
	add_action( 'init', 'bones_theme_register_block_patterns', 9 );
